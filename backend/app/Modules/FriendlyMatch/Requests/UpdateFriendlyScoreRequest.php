...
class UpdateFriendlyScoreRequest extends FormRequest
{
    ...
    {
        // Mêmes règles que UpdateMatchScoreRequest (tournament) : TB obligatoire
        // à 8-8, interdit sinon, écart ≥ 2 requis.
